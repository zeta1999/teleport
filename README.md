...
1. Download the container: `docker pull teleportdata/teleport:v0.0.1-alpha.3`
3. Run the container: `docker run teleportdata/teleport:v0.0.1-alpha.3 -e <ENV Variables> -v $(pwd):/pad [COMMAD] [OPTIONS]`
